...
<span class="token keyword">import</span> <span class="token string">"@patchwork/contracts/PatchworkProtocol/IPatchworkProtocol.sol"</span><span class="token punctuation">;</span>
</div>
</Info>
