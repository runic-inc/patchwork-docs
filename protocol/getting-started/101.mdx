---
title: 'Patchwork 101'
description: 'A 10 minute primer to help you understand how Patchwork works'
icon: 'graduation-cap'
---
...
The best way to dive into Patchwork is to scan through the information in the [`Core Concepts`](/protocol/core-concepts/) and [`Working with Patchwork`](/protocol/guide/) sections of the docs, check out the [`Quickstart`](/protocol/getting-started/quickstart.mdx) guide, and get your feet wet with our simple _"Hello World"_ tutorial on the [`Deploying your first app`](/protocol/getting-started/hello-world) page.